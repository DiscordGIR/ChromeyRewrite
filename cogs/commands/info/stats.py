...
class Stats(commands.Cog):
    ...
    async def ping(self, ctx: ChromeyContext) -> None:
    ...
    async def roleinfo(self, ctx: ChromeyContext, role: Option(discord.Role, description="Role to view info of")) -> None:
    ...
    async def stats(self, ctx: ChromeyContext) -> None:
    ...
    async def serverinfo(self, ctx: ChromeyContext):
    ...
    async def raidstats(self, ctx: ChromeyContext) -> None:
    ...
    async def casestats(self, ctx: ChromeyContext, mod: Option(discord.Member, required=False) = None) -> None:
