...
class AntiRaid(commands.Cog):
    ...
    async def raid(self, ctx: ChromeyContext, phrase: Option(str, description="Phrase to add")) -> None:
    ...
    # async def batchraid(self, ctx: ChromeyContext, *, phrases: str) -> None:
    ...
    async def removeraid(self, ctx: ChromeyContext, phrase: Option(str, description="Phrase to remove")) -> None:
    ...
    async def spammode(self, ctx: ChromeyContext, mode: Option(bool, description="True if you don't want to ban, False otherwise", required=False) = None) -> None:
    ...
    async def verify(self, ctx: ChromeyContext, user: Option(discord.Member, description="User to verify"), mode: Option(bool, required=False) = None) -> None:
    ...
    async def lock(self,  ctx: ChromeyContext, channel: Option(discord.TextChannel, description="Channel to lock", required=False) = None):
    ...
    async def unlock(self,  ctx: ChromeyContext, channel: Option(discord.TextChannel, description="Channel to unlock", required=False)  = None):
    ...
    async def freezeable(self,  ctx: ChromeyContext, channel: Option(discord.TextChannel, description="Channel to mark freezeable", required=False) = None):
    ...
    async def unfreezeable(self,  ctx: ChromeyContext, channel: Option(discord.TextChannel, description="Channel to mark as not freezeable", required=False) = None):
        channel = channel or ctx.channel
