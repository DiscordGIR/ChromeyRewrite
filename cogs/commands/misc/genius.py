...
class Genius(commands.Cog):
    ...
    async def commonissue(self, ctx: ChromeyContext, *, title: str):
    ...
    async def rawembed(self, ctx: ChromeyContext, *, channel: Option(discord.TextChannel, description="Channel the embed is in"), message_id: Option(str, description="ID of the message with the embed")):
        try:
