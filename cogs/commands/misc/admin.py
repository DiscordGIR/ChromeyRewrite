...
class Admin(commands.Cog):
    ...
    @admin_and_up()
    @slash_command(guild_ids=[cfg.guild_id], description="Change bot's profile picture", permissions=slash_perms.admin_and_up())
    async def setpfp(self, ctx: ChromeyContext):
