...
class MenuButtons(ui.View):
    def __init__(self, ctx: ChromeyContext, pages: list, page_formatter: Callable[[any, list, int, ChromeyContext], None], channel: discord.TextChannel, interaction: bool, whisper: bool, no_skip: bool = False, extra_buttons: Optional[List[discord.ui.Button]] = []):
