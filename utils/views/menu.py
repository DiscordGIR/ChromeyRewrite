...
from utils.context import ChromeyContext, ChromeyOldContext


class Menu(ui.View):
    def __init__(self, ctx: Union[ChromeyContext, ChromeyOldContext], entries: list, per_page: int, page_formatter: Callable[[Union[ChromeyContext, ChromeyOldContext], list, int, list], None], whisper: bool, show_skip_buttons: bool = True, start_page=1, non_interaction_message=None, timeout_function=None):
        super().__init__(timeout=60)

        self.ctx = ctx
        self.is_interaction = isinstance(ctx, ChromeyContext)
