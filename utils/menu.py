...
class Menu():
    def __init__(self, pages: list, channel: discord.TextChannel, format_page: Callable[[any, list, int, ChromeyContext], None], interaction: bool, ctx: ChromeyContext, whisper: bool = False, per_page=1, no_skip: bool = False, extra_buttons: List[discord.ui.Button] = []):
