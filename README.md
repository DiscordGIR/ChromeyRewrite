...
8. Open the integrated terminal in VSCode and run the `chromey` command to start the bot with hot reload!
...
```
CHROMEY_TOKEN="your token here"

MAIN_GUILD_ID=12345
OWNER_ID=12345
GUILD_OWNER_ID=123 # ID of whoever owns the server
